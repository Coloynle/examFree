            ...
            <form method="POST" action="{{ url('admin/question/manageQuestion/') }}" id="searchFrom">
                <div class="cl">
                    ...
                    <div class="btn-group f-l mr-10 mt-10" id="questionType">
                        <a class="btn btn-default radius" href="javascript:;" data-value="" onclick="chooseButton(this,$('input[name=type]'))">全部</a>
                        <a class="btn btn-default radius" href="javascript:;" data-value="SingleChoice" onclick="chooseButton(this,$('input[name=type]'))">单选题</a>
                        <a class="btn btn-default radius" href="javascript:;" data-value="MultipleChoice" onclick="chooseButton(this,$('input[name=type]'))">多选题</a>
                        <a class="btn btn-default radius" href="javascript:;" data-value="TrueOrFalse" onclick="chooseButton(this,$('input[name=type]'))">判断题</a>
                        <a class="btn btn-default radius" href="javascript:;" data-value="FillInTheBlank" onclick="chooseButton(this,$('input[name=type]'))">填空题</a>
                        <a class="btn btn-default radius" href="javascript:;" data-value="ShortAnswer" onclick="chooseButton(this,$('input[name=type]'))">简答题</a>
                    </div>
                    ...
                    @foreach( $questions as $item => $value )
                        <tr class="text-c">
                            ...
                            <td class="text-l text-overflow">
                                <u style="cursor:pointer" class="text-primary text-overflow" style="width: 300px" onClick="showLayer('查看','{{ url('admin/question/previewQuestion').'/'.$value['id'] }}')" title="查看">
                            ...
                            <td class="f-14 td-manage">
                                ...
                                @endif
                                <a style="text-decoration:none" class="ml-5" onclick="showLayer('编辑','{{ url('admin/question/changeQuestion').'/'.$value['id'] }}')" title="编辑" href="javascript:;">
...
{{--                    {{ dd($questions) }}--}}
            ...
            <div class="f-l">
                <ul class="pagination">
                    <li>
                        <a style="text-decoration:none" onClick="batchDeletion('del','questionId')" href="javascript:;" title="批量删除">
                            <i class="Hui-iconfont Hui-iconfont-del2"> </i>
                        </a>
                    </li>
                    <li>
                        <a style="text-decoration:none" onClick="batchDeletion('release','questionId')" href="javascript:;" title="批量发布">
                            <i class="Hui-iconfont Hui-iconfont-fabu"></i>
                        </a>
                    </li>
                    <li>
                        <a style="text-decoration:none" onClick="batchDeletion('underTheShelf','questionId')" href="javascript:;" title="批量下架">
                            <i class="Hui-iconfont Hui-iconfont-xiajia"></i>
                        </a>
                    </li>
                </ul>
